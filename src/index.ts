...
async function searchProfessionals({ category, zip_code, availability = "any", max_results = 3 }: any) {
...
async function getHomeAdvice({ question }: any) {
...
async function requestQuote({ professional_id, service_needed, homeowner_name, homeowner_zip, preferred_timing, notes }: any) {
